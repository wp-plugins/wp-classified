...
if ($wpcSettings['must_registered_user']=='y' && !$wpClassified->is_usr_loggedin()){
	...
	<form method="post" id="wpClassifiedForm" name="wpClassifiedForm" action="<?php echo wpcPublicLink("paform", array("lid"=>$_GET['lid'], "name"=>$lists["name"]));?>">
	<input type="hidden" name="add_ad" value="yes">
	<div class="editform">
	<h2>Details</h2><table><tr>
	<td class="wpc_label_right"><?php echo $lang['_AUTHOR']; ?></td>
	<td><?php if (!$wpClassified->is_usr_loggedin()){?>
	...
	?>
	"><span class="smallRed"><?php echo $lang['_REQUIRED']?></span></td></tr>
	<tr>
	...
	echo str_replace('"', '&quot;', $txt); 
	?>
	"><span class="smallTxt"><?php echo $lang['_OPTIONAL'];?></span></td></tr>
	...
	"><span class="smallTxt"><?php echo $lang['_OPTIONAL']; ?>&nbsp; e.g. +98(231)12345</span></td></tr>
	...
	?>
	<div style="text-align: center;"><?php wpcAdInput($_POST['wpClassified_data']['post']); ?></div>
	<td>
	</tr>
